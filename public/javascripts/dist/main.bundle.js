...
var routes = (
  React.createElement(Route, {name: "layout", path: "/", handler: Feed, ignoreScrollBehavior: true}, 
    React.createElement(Route, {name: "now", path: "2015/", handler: CurrentFeed}), 
    React.createElement(Route, {name: "2014", path: "2014/", handler: ArchiveFeed}), 
    React.createElement(Route, {name: "2013", path: "2013/", handler: ArchiveFeed}), 
    React.createElement(Route, {name: "2012", path: "2012/", handler: ArchiveFeed}), 
    "// ", React.createElement(Route, {name: "previous", path: "/:year", handler: ArchiveFeed}), 

    React.createElement(Redirect, {from: "/", to: "now"})
  )
);
  ...
  render: function() {
    ...
    return (
      ...
      React.createElement("ul", null, 
        React.createElement("li", null, React.createElement(Link, {to: "2012"}, "2012")), 
        React.createElement("li", null, React.createElement(Link, {to: "2013"}, "2013")), 
        React.createElement("li", null, React.createElement(Link, {to: "2014"}, "2014")), 
        React.createElement("li", null, React.createElement(Link, {to: "now"}, "2015"))
      )
    );
  }
